...
class Content
{
     ...
     * @param Schema $schema The schema defining the type used for the content.
     * @param ArraySchema $array The schema of the array that defines the type used for the content.
