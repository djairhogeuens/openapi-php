...
class ArraySchema
{
     ...
     * @param Schema|null $arraySchema Allows to define the properties to be resolved into properties of the schema of type `array` (not the ones of the `$items` of such schema which are defined in {@see ArraySchema::$schema schema}.
