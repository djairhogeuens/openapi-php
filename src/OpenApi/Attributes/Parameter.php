...
class Parameter implements OpenApiAttributeInterface
{
     ...
     * @param ParameterIn $in The location of the parameter. Possible values are "query", "header", "path" or "cookie". Ignored when empty string.
     ...
     * @param ParameterStyle $style Describes how the parameter value will be serialized depending on the type of the parameter value. Default values (based on value of in): for query - form; for path - simple; for header - simple; for cookie - form. Ignored if the properties content or array are specified.
     * @param Explode $explode When this is true, parameter values of type array or object generate separate parameters for each value of the array or key-value pair of the map. For other types of parameters this property has no effect. When style is form, the default value is true. For all other styles, the default value is false. Ignored if the properties content or array are specified.
    ...
    public function __construct(
        public string $name = "",
        public ParameterIn $in = ParameterIn::NONE,
        public string $description = "",
        public bool $required = false,
        public bool $deprecated = false,
        public bool $allowEmptyValue = false,
        public ParameterStyle $style = ParameterStyle::NONE,
        public Explode $explode = Explode::NONE,
