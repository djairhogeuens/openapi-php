...
{
    /**
     * @param SecuritySchemeType|null $type The type of the security scheme. Valid values are "apiKey", "http", "oauth2", "openIdConnect".
     ...
     * @param SecuritySchemeIn|null $in The location of the API key. Valid values are "query" or "header". Applies to apiKey type.
    ...
    public function __construct(
        public ?SecuritySchemeType $type = null,
        public string $name = "",
