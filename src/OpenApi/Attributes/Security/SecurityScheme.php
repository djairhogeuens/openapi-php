...
{
    /**
     * @param SecuritySchemeType $type The type of the security scheme. Valid values are "apiKey", "http", "oauth2", "openIdConnect".
     ...
     * @param SecuritySchemeIn $in The location of the API key. Valid values are "query" or "header". Applies to apiKey type.
    ...
    public function __construct(
        public SecuritySchemeType $type = SecuritySchemeType::NONE,
        public string $name = "",
        public string $description = "",
        public string $paramName = "",
        public SecuritySchemeIn $in = SecuritySchemeIn::NONE,
